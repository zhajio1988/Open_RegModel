...
class ordt_rg_ral_regs_demo_CTRL : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> PRESCALER;
    ordt_field<uint_fast8_t> MODE;
    ordt_field<uint_fast8_t> MASTER;
    ordt_field<uint_fast8_t> DORD;
    ordt_field<uint_fast8_t> ENABLE;
    ordt_field<uint_fast8_t> CLK2X;
    ordt_rg_ral_regs_demo_CTRL(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_ral_regs_demo_INTCTRL : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> INTLVL;
    ordt_rg_ral_regs_demo_INTCTRL(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_ral_regs_demo_STATUS : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> WRCOL;
    ordt_field<uint_fast8_t> IF;
    ordt_rg_ral_regs_demo_STATUS(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_ral_regs_demo_RCNT_SAT : public ordt_reg {
  public:
    ordt_field<uint32_t> str;
    ordt_field<uint_fast8_t> subch;
    ordt_field<uint_fast8_t> en;
    ordt_rg_ral_regs_demo_RCNT_SAT(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_ral_regs_demo : public ordt_regset {
  public:
    ordt_rg_ral_regs_demo_CTRL CTRL;
    ordt_rg_ral_regs_demo_INTCTRL INTCTRL;
    ordt_rg_ral_regs_demo_STATUS STATUS;
    ordt_rg_ral_regs_demo_RCNT_SAT RCNT_SAT;
    ordt_rset_ral_regs_demo(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_root : public ordt_regset {
  public:
    ordt_rset_ral_regs_demo ral_regs_demo;
    ordt_root();
